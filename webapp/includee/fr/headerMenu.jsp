...
<!--     <div id="main-wrapper"> -->
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
        <div class="nav-header" style="background-color: #16213E;">
            <a href="${cPath }/fr" class="brand-logo" style="padding-top: 20px;">
                <img src="${cPath}/resources/dashboard3/images/white-logo.png" alt="" style="width:205px;">
            </a>
        ...
        ***********************************-->
		...
		<!--**********************************
            Header start
        ***********************************-->
        <div class="header" style="background-color: #16213E;">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" role="button" data-toggle="dropdown">
									<div class="header-info">
										...
										<span>Hello, <strong>${authMember.realMember.ownerId }</strong></span>
									</div>
									<img src="${cPath}/resources/dashboard3/images/roopi.png" width="20"/>
                                </a>
                            </li>
                            
                            <li class="nav-item dropdown notification_dropdown">
                           	    <form:form method="post" action="${pageContext.request.contextPath}/logout" id="logoutForm" width="20"/>
	              				<a href="#" onclick="logoutForm.submit();" class="btn light btn-primary btn-xs" style="background-color: white;">
