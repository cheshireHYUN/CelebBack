            ...
            <div class="container-fluid">
                    ...
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4><strong>공지사항</strong></h4>
          					<span>공지사항을 조회, 등록, 수정, 삭제할 수 있습니다.</span>
                        </div>
                    </div>
                ...
                <div id="searchUI" class="row" style="margin-bottom: 15px;">
                	<div style="float: left; width: 45%;">
                		<button id="insertBtn" type="button" class="btn btn-primary" style="border: none" onclick="location.href='${cPath}/head/Notice/form';">공지사항 글 작성</button>
                	</div>
                                ...
                                <table class="display mb-4 dataTablesCard table table-hover table-responsive-sm dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 10%; text-align: center;"><strong>공개범위</strong></th>
...
<form id="searchForm" method="get" action="${cPath }/head/Notice" >
<sec:csrfInput/>
...
// 		let aTag = $("<a>").attr("href", "${cPath}/head/Notice/"+notice.postNo)
// 							.text(notice.postTitle)
		 return $("<tr>").append(
			        	$("<td style='text-align: center;'>").html(notice.rnum)
			        	,$("<td style='text-align: center;'>").html(notice.lgu.lguName)
			        	,$("<td style='padding-left: 2%;'>").html(notice.postTitle)
			        	,$("<td style='text-align: center;'>").html(notice.postDate)
	   			 ).attr({
	   					"onclick" : "location.href='${cPath }/head/Notice/"+notice.postNo+"'",
