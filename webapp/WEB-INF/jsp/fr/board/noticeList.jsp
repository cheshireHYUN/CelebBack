                ...
                <div class="row page-titles" style="margin-bottom: 15px;">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4><strong>본사 공지사항</strong></h4>
          					<span>본사 공지사항을 조회할 수 있습니다.</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
					    <ol class="breadcrumb">
					        <li class="breadcrumb-item"><a href="javascript:void(0)">게시판관리</a></li>
					        <li class="breadcrumb-item active"><a href="javascript:void(0)">본사 공지사항</a></li>
					    </ol>
					</div>
                </div>
                <!-- row -->
...
<form id="searchForm" method="get" action="${cPath }/fr/Notice" >
<sec:csrfInput/>
	...
	let makeSingleTr = function(index, notice){
		 return $('<tr>').append(
			        	...
			        	,$("<td style='text-align: center;'>").html(notice.postDate)
	   					...
	   					"onclick" : "location.href='${cPath }/fr/Notice/"+notice.postNo+"'",
