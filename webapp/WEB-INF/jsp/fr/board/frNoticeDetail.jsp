                            ...
                            <div class="card-body">
                                <div class="table-responsive" style="overflow-x: hidden;">
                                    <table class="table table-responsive-md">
                                        <tbody>
                                        	<tr>
							                    <td><h4><strong>${frNotice.postTitle }</strong></h4></td>
                                    ...
                                    <div class="row">
	                                    <div style="width: 50%; text-aligh: left;">
	                                    	<input type="button" value="목록" class="btn light btn-success" onclick="location.href='${cPath }/fr/frNotice'" />
	                                    </div>
	                                    <div style="width: 50%; text-align: right;">
		                                    <input type="button" value="수정" class="btn btn-primary" onclick="location.href='${cPath }/fr/frNotice/${frNotice.frannoticeNo }/form'" />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="${cPath }/fr/frNotice/${frNotice.frannoticeNo }" method="post" name="frNotice">
       <sec:csrfInput/>
