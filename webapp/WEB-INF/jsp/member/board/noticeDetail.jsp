		...
		<div class="pattern_2">
		    <div class="container margin_60_40">
		        <table class="table table-striped cart-list">
		            ...
		            <tbody>
		                <tr>
		                    <td style="padding-left: 2%;"><strong>${notice.postTitle }</strong></td>
		                    <td style="text-align: right; padding-right: 2%;">${notice.postDate }</td>
		                </tr>
		                <tr>
		                	...
		                	<td colspan="2" style="padding-left: 2%;">
		                		<c:if test="${not empty notice.attatchList }">
									<c:forEach items="${notice.attatchList }" var="attatch" varStatus="vs">
										<a href="${cPath }/Notice/${notice.postNo }/attatch/${attatch.attatchNo}">${attatch.attatchOrgname }</a>
